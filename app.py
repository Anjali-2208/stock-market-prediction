...
def stock_prediction_app():
    # Add background image (replace with your local image path)
    add_bg_from_local("images.jpg")  # Update this path
    
    st.sidebar.header("Stock Selection")
    stock_options = ['AAPL', 'GOOG', 'MSFT', 'TSLA', 'AMZN']
    stock = st.sidebar.selectbox('Choose Stock Symbol', stock_options)
